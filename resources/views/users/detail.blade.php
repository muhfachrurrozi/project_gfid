            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        @if ($user->poto)
                            <img src="{{asset('avatar/'.$user->poto) }}" alt="Profile" class="rounded-circle">
                        @else
                            No Avatar
                        @endif
                        <h2>{{ $user->name }}</h2>
                        <h3>{{ $user->dept }} | {{ $user->jabatan }}</h3>
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->dept }}</div>
                                </div>
                                <div class="row">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <form class="row g-3" action="{{ Route('users.update',[$user->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="telepon" type="text" class="form-control" id="telepon" value="{{ $user->telepon }}">
                                        </div>
                                    </div>
